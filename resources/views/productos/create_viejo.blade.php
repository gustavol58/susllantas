  ...
  <div class="card-body">
    ...
    <form id="form_crear_producto" method="post" action="javascript:void(0)">
        ...
        <div class="form-group row required">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="codigo" name="codigo" value="{{old('codigo')}}" autofocus>
          </div>
        ...
        <div class="form-group row required">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="num_parte" name="num_parte" value="{{old('num_parte')}}">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="unidad" name="unidad" value="{{old('unidad')}}">
          </div>
        ...
        <div class="form-group row required">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control" id="precio_a" name="precio_a" value="{{old('precio_a')}}">
          </div>
        ...
        <div class="form-group row required">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control" id="precio_b" name="precio_b" value="{{old('precio_b')}}">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="aux_1" name="aux_1" value="{{old('aux_1')}}">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="consu_c" name="consu_c" value="{{old('consu_c')}}">
          </div>
        ...
        <div class="form-group row required">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="iva_dif" name="iva_dif" value="{{old('iva_dif')}}">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="iva_difs" name="iva_difs" value="{{old('iva_difs')}}">
          </div>
