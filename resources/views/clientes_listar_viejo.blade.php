  ...
  <div id="app">
    <div class="container-fluid">
      ...
      <div class="large-table-fake-top-scroll-container-3">
        {{-- 06oct2019 los siguientes 400 caracteres (que deben tener un
        ...
        <div style=""></div>
        ...
        <table class="table table-bordered display"   id="laravel_datatable_clientes" >
           <thead>
              <tr>
                 ...
                 <th>Cuentas ahorros</th>
                 <th>Banco ahorros</th>
                 <th>Estado</th>
                 <th>Agente cree</th>
                 <th>Agente exen</th>
                 <th>Retenedor cree</th>
                 <th>Declarante</th>
                 <th>Importador</th>
                 <th>Agente ica</th>
                 <th>Agente rete ica</th>
                 <th>Bolagro</th>
                 <th>Auto rete ica</th>
                 <th>Id</th>
              </tr>
              <tr>
                 ...
                 <td>Web site</td>
                 <td>Departamento</td>
                 <td>Dígito verificación</td>
                 <td>Apellido 1</td>
                 <td>Apellido 2</td>
                 <td>Nombre 1</td>
                 <td>Nombre 2</td>
                 <td>Persona jurídica</td>
                 <td>Cuentas ahorros</td>
                 <td>Banco ahorros</td>
                 <td>Estado</td>
                 <td>Agente cree</td>
                 <td>Agente exen</td>
                 <td>Retenedor cree</td>
                 <td>Declarante</td>
                 <td>Importador</td>
                 <td>Agente ica</td>
                 <td>Agente rete ica</td>
                 <td>Bolagro</td>
                 <td>Auto rete ica</td>
                 <td>Id</td>
              </tr>
